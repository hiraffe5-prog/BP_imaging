...
[DEM_crop]=DEM_crop_fun(globalDEM_path,lon_lat_range); 
del_lat = 0.02;
del_lon = 0.02;
...
[DEM_interp]=DEM_resample(DEM_crop,lon_lat_range,lon,lat);
DEM = DEM_interp(1:1:end,1:1:end)*0; 
...
[pos_list]=scatter_pos(L_vec,B_vec);
...
%sigma=sigma.';
sigma=sigma(:);
sigma(pos_list) = 20*sigma(pos_list);
